...
public:
    Numerical_Player(string name, T symbol, int turn);
    ~Numerical_Player();
...
class Numerical_Random_Player : public RandomPlayer<T> {
    int turn;
public:
    Numerical_Random_Player(T symbol, int turn);
...
template <typename T>
Numerical_Player<T>::Numerical_Player(string name, T symbol, int turn):Player<T>(name, symbol) {this->turn=turn;}
...
template <typename T>
Numerical_Random_Player<T>::Numerical_Random_Player(T symbol, int turn)
