...
public:
    Word_MinMax_Player(T symbol, const unordered_set<string>& dictionary);
    ~Word_MinMax_Player();
    void getmove(int& x, int& y) override;
};

template <typename T>
Word_MinMax_Player<T>::Word_MinMax_Player(T symbol, const unordered_set<string>& dictionary)
    : Player<T>(symbol), dictionary(dictionary) {
    this->name = "AI Player";
